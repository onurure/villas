	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>{{ Ceviri('Email Onaylama') }}</h2>

				<!-- Breadcrumbs -->
				<nav id="breadcrumbs">
					<ul>
						<li><a href="{{url('/')}}">{{ Ceviri('Anasayfa') }}</a></li>
						<li>{{ Ceviri('Email Onaylama') }}</li>
					</ul>
				</nav>
...
<div class="container">
	...
	<div class="my-account style-1 margin-top-5 margin-bottom-40">
		...
		<ul class="tabs-nav">
			<li class=""><a href="#tab1">{{ Ceviri('Email Onaylama') }}</a></li>
		</ul>
		...
		<div class="tabs-container alt">
			...
			<div class="tab-content" id="tab1" style="display: none;">
				<form method="post" class="login" action="">
					...
					<p class="form-row">
						<input type="submit" class="button border margin-top-10" name="login" value="{{ Ceviri('Onayla') }}" />
						<!--
